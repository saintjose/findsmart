...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.lancement}>
      <ImageBackground
        source={require("../assets/lancement.jpg")}
        ...
        <View style={styles.lancement.frame}>
          <View style={styles.lancement.heading}>
            <Text style={styles.lancement.textWrapper}>
              Rester chez vous et trouvez un prestataire pour vos services
            </Text>
            ...
            <Text
              style={styles.lancement.btnSuivant}
              onPress={() => navigation.navigate("Connexion")}
            >
              <FontAwesome5
                name="arrow-right"
                size={30}
                style={styles.lancement.icon}
              />
            </Text>
          </View>
        </View>
